<script lang="ts">
    ...
    export let animin: { duration: number; start: number,  } = { duration: 300, start: 1,  };
    export let animout: { duration: number; start: number,  } = { duration: 300, start: 1,  };
  ...
  <div
    ...
    in:flyAndScale={{ duration: animin.duration, start: animin.start }}
    out:flyAndScale={{ duration: animout.duration, start: animout.start   }}
    class={cn(
