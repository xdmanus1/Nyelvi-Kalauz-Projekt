...
declare module '$env/static/private' {
	...
	export const npm_package_dependencies_furigana: string;
	...
	export const npm_package_dependencies_wanakana: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		SHLVL: string;
		BROWSER: string;
		npm_package_dependencies_furigana: string;
		...
		PWD: string;
		npm_execpath: string;
		npm_package_dependencies_wanakana: string;
